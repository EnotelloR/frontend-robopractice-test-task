...
Приложение реализует указанные в задании основные и все  дополнительные функции, а именно:
- для каждой колонки реализована сортировка по возрастанию и убыванию;
- реализован поиск по имени пользователя;
- реализована пагинация;
- первый и последний столбцы приклеены к своим сторонам;
- колонки resizeable.
